...
2. Logo / Brand Link
  - `<a href="index3.html" class="brand-link"><img src="{% static 'main/img/icon/imigrasi-logo.png' %}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"><span class="<span class="brand-text font-weight-light">Kanim Cilegon</span>">AdminLTE 3</span></a>` replaces the old logo
3. Sidebar
